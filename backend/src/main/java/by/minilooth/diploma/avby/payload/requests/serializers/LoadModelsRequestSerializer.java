...
public class LoadModelsRequestSerializer extends JsonSerializer<LoadModelsRequest> {

    @Override
    public void serialize(LoadModelsRequest request, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
